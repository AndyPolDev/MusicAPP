...
class DataBase {
    ...
    func saveUser(firstName: String, secondName: String, phone: String, email: String, age: Date, password: String) {
        
        let user = User(firstName: firstName, secondName: secondName, phone: phone, email: email, age: age, password: password)
