...
class SignUpViewController: UIViewController {
    ...
    @objc private func signUpButtonPressed() {
        ...
        if firstNameText.isValid(validType: nameValidType),
           ...
           ageIsValid() == true {
            ...
            alertOK(title: "Error", message: "Fill in all the fields. Your age must be 18+ y.o.")
        }
    }
    ...
    private func setupDatePicker() {
        ...
        datePicker.layer.borderColor = #colorLiteral(red: 0.8823529412, green: 0.8823529412, blue: 0.8823529412, alpha: 1)
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        case passwordTextField:
            setTextField(textField: passwordTextField,
                         ...
                         wrongMessage: "pass must contain 6 letters and numbers at least",
                         string: string,
                         range: range)
